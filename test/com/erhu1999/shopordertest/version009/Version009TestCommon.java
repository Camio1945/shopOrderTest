...
import static com.erhu1999.shopordertest.version009.JdbcUtil009.dropDbIfExistsThenCreateDb;
import static com.erhu1999.shopordertest.version009.JdbcUtil009.execSqlFile;
import static com.erhu1999.shopordertest.version009.JdbcUtil009.init;
import static com.erhu1999.shopordertest.version009.JdbcUtil009.queryOneRow;
import static com.erhu1999.shopordertest.version009.JdbcUtil009.renewUrl;
import static org.junit.jupiter.api.Assertions.assertEquals;

/**
 * 版本009的测试用例
 */
class Version009TestCommon extends AbstractTest {

    /** 数据库名称 */
    private static final String DB_NAME = DB_NAME_PREFIX + "version009";
    /** 数据库连接数量 */
    ...
    static void initDb() throws SQLException {
        printSeparateLine(Version009TestCommon.class.getSimpleName(), new Exception().getStackTrace()[0].getMethodName());
        ...
        // 重新初始化数据库连接相关的参数
        renewUrl(DB_NAME);
        String sqlFilePath = Version009TestCommon.class.getResource("").getFile() + Version009TestCommon.class.getSimpleName() + ".sql";
    ...
    private static void initDataSourceByHikari() throws SQLException {
        ...
        // 切换数据源
        JdbcUtil009.setDataSource(hikariDataSource);
     ...
     * @param isSynchronizedMethod 是否调用同步的方法
     * @throws Exception
     */
    static void testMultiThread(int threadCount, boolean isSynchronizedMethod) throws Exception {
        // 商品ID
        Long goodsId = 1L;
        // 查询商品信息
        ...
        Version009 version009 = new Version009();
                ...
                for (int i = 0; i < times; i++) {
                    ...
                    try {
                        if (isSynchronizedMethod) {
                            version009.submitOrderSynchronized(userId, goodsId, goodsCount, addrId);
                        } else {
                            version009.submitOrder(userId, goodsId, goodsCount, addrId);
                        }
                    } catch (Exception e) {
