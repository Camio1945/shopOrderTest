 ...
 * 版本005的测试用例
 */
class Version005Test0048 extends AbstractTest {
    ...
    @Test
    @DisplayName(Version005.DISPLAY_NAME + " 多线程测试 线程数 0048")
    void testOf0048Threads() throws Exception {
        printSeparateLine(this.getClass().getSimpleName(), new Exception().getStackTrace()[0].getMethodName());
        Version005TestCommon.testMultiThread(48);
    }
