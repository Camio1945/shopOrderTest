 ...
 * 版本005的测试用例
 */
class Version005Test0365 extends AbstractTest {
    ...
    @Test
    @DisplayName(Version005.DISPLAY_NAME + " 多线程测试 线程数 0365")
    void testOf0365Threads() throws Exception {
        printSeparateLine(this.getClass().getSimpleName(), new Exception().getStackTrace()[0].getMethodName());
        Version005TestCommon.testMultiThread(365);
    }
