 ...
 * 版本005的测试用例
 */
class Version005Test0243 extends AbstractTest {
    ...
    @Test
    @DisplayName(Version005.DISPLAY_NAME + " 多线程测试 线程数 0243")
    void testOf0243Threads() throws Exception {
        printSeparateLine(this.getClass().getSimpleName(), new Exception().getStackTrace()[0].getMethodName());
        Version005TestCommon.testMultiThread(243);
    }
