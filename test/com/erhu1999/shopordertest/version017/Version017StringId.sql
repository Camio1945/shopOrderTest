...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '地址' ROW_FORMAT = Dynamic;
 -- ----------------------------
-- Records of Addr
-- ----------------------------
INSERT INTO `Addr` VALUES ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '18812345678', '张三', '北京市海淀区一个假的收货地址');
 -- ----------------------------
...
-- Records of Goods
-- ----------------------------
INSERT INTO `Goods` VALUES ('00000000-0000-0000-0000-000000000001', '锤子（smartisan ) 坚果 Pro 2S 6G+64GB 炫光蓝 全面屏双摄 全网通4G手机 双卡双待 游戏手机', 199800, 320, 0, 1, 'https://resource.smartisan.com/resource/25cc6e783a664fbdf83c3c34774a9826.png', 'https://resource.smartisan.com/resource/25cc6e783a664fbdf83c3c34774a9826.png', 20180901115333000);
 -- ----------------------------
...
CREATE TABLE `OrderGoods`  (
  ...
  `goodsId` varchar(36) NOT NULL COMMENT '商品ID',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '订单商品' ROW_FORMAT = Dynamic;
 -- ----------------------------
...
-- Records of User
-- ----------------------------
INSERT INTO `User` VALUES ('00000000-0000-0000-0000-000000000001', '张三');
